...
import devDirect from "../assets/devdirect.png";
    ...
    <div name="work" className="w-full md:h-screen text-gray-300 bg-slate-900">
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <div
            style={{ backgroundImage: `url(${devDirect})` }}
            className="shadow-lg shadow-[#040c16] group container rounded-md flex justify-center text-center items-center mx-auto content-div"
          >
            {/* hover effect */}
            <div className="opacity-0 group-hover:opacity-100">
              <span className="text-2xl font-bold text-black tracking-wider">
                devDirect- Group Project 3 using React, TailWindCSS, MongoDB,
                Express.js, Node.js and Deployment to Heroku
              </span>
              <div className="pt-8 text-center">
                <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                  <a href="https://dev-direct.herokuapp.com/" target="_blank">
                    Application
                  </a>
                </button>
                ...
                <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                  <a
                    href="https://github.com/MegMathis/DevDirect"
                    target="_blank"
                  >
                    GitHub
                  </a>
